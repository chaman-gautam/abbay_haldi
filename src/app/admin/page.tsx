...
export default function AdminDashboardPage() {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Optional: call logout API if you create one later
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="bg-white border border-gray-200 shadow-sm rounded-xl px-4 py-2 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#b38b4d] text-white flex items-center justify-center font-bold">
              A
            </div>
            <div>
          ...
          <button
            ...
            className="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg font-medium cursor-pointer transition"
          >
            Logout
          </button>
        </div>
