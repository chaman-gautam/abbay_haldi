...
const AboutIntroSection = () => {
  return (
    <section className="bg-white text-center py-16 px-6 md:px-20 lg:px-32">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-[15px] leading-relaxed text-gray-800">
          ...
          <p>
            ...
            enjoy beautiful hair that grows out gracefully, creating a
          ...
          <p>
            ...
            the world. In 2018, she trained salon owners from Japan in
          ...
          <p>
            ...
            to inspiring women and professionals to embrace healthy, effortless
